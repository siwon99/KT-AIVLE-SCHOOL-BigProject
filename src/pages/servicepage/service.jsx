...
const ServiceIntro = () => {
  return (
    <div>
      ...
      <div className="intro">
        <h4>서비스 소개</h4>
        <p>1. NONGBU는 AI 기술을 활용하여 농업에서 사용되지 않거나 저활용된 땅을 감지하고 임대할 수 있도록 돕습니다.<br />이를 통해 농업 생산성을 높이고, 지역 경제를 활성화할 수 있습니다.</p>
      ...
      <div className="effects">
        ...
        <p>2. 정부를 통한 청년 농부들의 자본(땅) 마련을 지원하여, 초기 자본 부족 문제를 해결합니다.<br />따라서 청년들이 농업을 시작하는 데 필요한 지원을 받을 수 있습니다.</p>
        <p>3. 지역의 농지 활용을 통해 지역사회의 활력을 증진시킵니다.<br />이는 농업 생산성을 높이고, 지역 경제를 활성화하는 데 기여합니다.</p>
        <p>4. 농업 기술의 발전과 지속 가능한 농업 모델 구축을 통해 환경 보호와 경제적 성장을 동시에 추구합니다.<br />NONGBU는 미래 세대에게 지속 가능한 농업 환경 제공을 추구합니다.</p>
      </div>
    </div>
  );
};
